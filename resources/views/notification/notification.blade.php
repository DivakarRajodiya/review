...
@section('content')
    ...
    <div class="body">
        ...
        <ul class="nav nav-tabs tab-nav-right" role="tablist">
            <li role="presentation" class="active"><a href="#home" data-toggle="tab"><h4>{{$lang->get(64)}}</h4></a>
            </li>
                                                ...
                                                <td>
                                                    @foreach($petani as $key => $dataimage)
                                                        @if ($dataimage->id == $data->image)
                                                            <img src="images/{{$dataimage->filename}}" height="50"
                ...
                <form id="formcreate" method="post" action="{{url('sendmsg')}}">
                            ...
                            <div class="form-group form-group-lg form-float">
                                <div class="form-line">
                                    <select name="user" id="user" class="form-control" data-live-search="true">
                                        <option value="-1"
                                                style="font-size: 18px !important;">{{$lang->get(286)}}</option> {{--Send to All users--}}
                                        @foreach($iusers as $key => $datausers)
                                            <option value="{{$datausers->id}}"
                                                    style="font-size: 18px !important;">{{$datausers->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-2 form-control-label">
                            ...
                            <br>
                            <div align="center">
                                <button type="button" onclick="fromLibrary()"
                                        class="btn btn-primary m-t-15 waves-effect "><h5>{{$lang->get(77)}}</h5>
                                </button>
                            </div>
                        </div>
                        <div class="col-md-10">
